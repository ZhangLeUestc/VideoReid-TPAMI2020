...
def main(args):
    ...
    dataset, dataset_test, num_classes, train_loader,  query_loader, gallery_loader  = get_data(args.dataset,
                                                                                                        args.split,
                                                                                                         args.data_dir,
                                                                                                         args.height,
                                                                                                         args.width,
    ...
    checkpoint = load_checkpoint(osp.join('/home/zhangle/crf_affinity/logs/mars/resfpnnet50', 'cnncheckpoint.pth.tar'))
    cnnmodel.load_state_dict(checkpoint['state_dict'])

    checkpoint = load_checkpoint(osp.join('/home/zhangle/crf_affinity/logs/mars/resfpnnet50', 'crfcheckpoint.pth.tar'))
    crfmodel.load_state_dict(checkpoint['state_dict'])

    checkpoint = load_checkpoint(osp.join('/home/zhangle/crf_affinity/logs/mars/resfpnnet50', 'classifiercheckpoint.pth.tar'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-dir', type=str, metavar='PATH',
                        default='/home/zhangle/kpm_rw_person_reid/examples/data')
