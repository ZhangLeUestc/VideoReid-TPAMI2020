...
class Mars_train(object):
    ...
    def __init__(self, root='data', num_frame=8, min_seq_len=0, verbose=True, **kwargs):
    ...
    def _process_data(self, names, meta_data, home_dir=None, relabel=False, min_seq_len=0):
        ...
        for tracklet_idx in range(num_tracklets):
            ...
            idx_=range(start_index-1,end_index)
            Idx=idx_[0::self.num_frame]
            img_names = [names[i] for i in Idx]
            ...
            if len(img_paths) >= min_seq_len:
                for img_path in img_paths:
                    tracklets.append((img_path, pid, camid))
